...
namespace Ejercicio4_Alumnos_Maestros_
{
    public partial class frmMaestro : Form
    {
        ...
        private void btnCapturar_Click(object sender, EventArgs e)
        {
            ...
            if (contM <= objMaestro.cantidadMateriasMaestro.Length)
            {
                objMaestro.materias[cont,contM] = txtMateria.Text;
                contM++;
                txtMateria.Text = " ";
            }
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            objMaestro.cantMatM = (int)nudCantidadMaestros.Value;
            objMaestro.materias = new string[cantidadMaestros,objMaestro.cantMatM];
            grbMaterias.Enabled = true;
        }
