...
namespace proyectoCalificacionesUnidad6
{
    ...
    {
        TextWriter archivoIGE;
        TextWriter archivoITIC;
        TextWriter archivoIIA;
        TextWriter archivo;
        IGE objIGE = new IGE();
        ...
        public string mejorCarrera;
        public double mejorPromedio;
        public double mejorPromedioIGE;
        public string mejorAlumnoIGE;
        public int numControlMA_IGE;
        public double mejorPromedioITIC;
        public string mejorAlumnoITIC;
        public int numControlMA_ITIC;
        public double mejorPromedioIIA;
        public string mejorAlumnoIIA;
        public int numControlMA_IIA;
        ...
        {
            archivoIGE = new StreamWriter("ArchivoProyectoCalificacionesIGE.txt");
            archivoITIC = new StreamWriter("ArchivoProyectoCalificacionesITIC.txt");
            archivoIIA = new StreamWriter("ArchivoProyectoCalificacionesIIA.txt");
            archivo = new StreamWriter("ArchivoInforme.txt");
        }
        ...
        public void imprimirDatosITIC()
        {
            ...
            archivoITIC.WriteLine(datosITIC);
            archivoITIC.Close();
        }
                ...
                case "IGE":
                    {
                        ...
                        leerArchivo = new StreamReader("ArchivoProyectoCalificacionesIGE.txt");
                ...
                case "ITIC":
                    {
                        ...
                        leerArchivo = new StreamReader("ArchivoProyectoCalificacionesITIC.txt");
                ...
                case "IIA":
                    {
                        ...
                        leerArchivo = new StreamReader("ArchivoProyectoCalificacionesIIA.txt");
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            switch (cmbCarreras.Text)
            {
                case "IGE":
                    {
                        Process.Start("ArchivoProyectoCalificacionesIGE.txt");
                        break;
                    }
                case "ITIC":
                    {
                        Process.Start("ArchivoProyectoCalificacionesITIC.txt");
                        break;
                    }
                case "IIA":
                    {
                        Process.Start("ArchivoProyectoCalificacionesIIA.txt");
                        break;
                    }
            }
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            var cadena = "La mejor carrera es: " + mejorCarrera + "\nCon un promedio de: " + mejorPromedio;
            cadena += "\n" + "\nCuadro de honor" + "\n";
            cadena += "\nAlumno de IGE con mejor promedio es: " + mejorAlumnoIGE + "\nCon un promedio de : " + mejorPromedioIGE + "\n";
            cadena += "\nAlumno de ITIC con mejor promedio es: " + mejorAlumnoITIC + "\nCon un promedio de : " + mejorPromedioITIC + "\n";
            cadena += "\nAlumno de IGE con mejor promedio es: " + mejorAlumnoIIA + "\nCon un promedio de : " + mejorPromedioIIA + "\n";
            archivo.WriteLine(cadena);
            archivo.Close();
            MessageBox.Show("Los datos se han guardado exitosamente");
        }

        private void btnLeerInforme_Click(object sender, EventArgs e)
        {
            TextReader leerArchivo;

            leerArchivo = new StreamReader("ArchivoInforme.txt");

            MessageBox.Show(leerArchivo.ReadToEnd(), "ArchivoInforme.txt");
        }
