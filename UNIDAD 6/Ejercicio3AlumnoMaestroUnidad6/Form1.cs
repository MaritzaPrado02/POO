...
namespace Ejercicio3AlumnoMaestroUnidad6
{
    public partial class frmDatos : Form
    {
        ...
        int cont;
        TextWriter archivoAlumno;
        TextWriter archivoMaestro;
        ...
        {
            archivoAlumno = new StreamWriter("ArchivoDatosAlumno.txt");
            archivoMaestro = new StreamWriter("ArchivoDatosMaestro.txt");
        ...
        public void ImprimirDatosMaestro()
        {
            ...
            MessageBox.Show(datos,"Datos Maestro");
            archivoMaestro.WriteLine(datos);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (cmbOcupacion.Text == "Maestro")
                {
                    ...
                    objMaestro.telefono = long.Parse(txtTelefono.Text);
        ...
        private void btnLeer_Click(object sender, EventArgs e)
        {
            if (cmbOcupacion.Text == "Alumno")
            {
                ...
                leerArchivo = new StreamReader("ArchivoDatosAlumno.txt");

                MessageBox.Show(leerArchivo.ReadToEnd(), "ArchivoDatosAlumno.txt");
            }
            else
            {
                if (cmbOcupacion.Text == "Maestro")
                {
                    ...
                    leerArchivo = new StreamReader("ArchivoDatosMaestro.txt");

                    MessageBox.Show(leerArchivo.ReadToEnd(), "ArchivoDatosMaestro.txt");
                }
            }
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            if (cmbOcupacion.Text == "Alumno")
            {
                Process.Start("ArchivoDatosAlumno.txt");
            }
            else
            {
                if (cmbOcupacion.Text == "Maestro")
                {
                    Process.Start("ArchivoDatosMaestro.txt");
                }
