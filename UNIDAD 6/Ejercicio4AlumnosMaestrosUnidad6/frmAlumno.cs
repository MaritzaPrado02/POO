...
namespace Ejercicio4AlumnosMaestrosUnidad6
{
    public partial class frmAlumno : Form
    {
        ...
        private void btnRegistrarAlumnos_Click(object sender, EventArgs e)
        {
            ...
            objAlumno.MatA = new int[cantidadAlumnos];
        }
        ...
        {
            archivo = new StreamWriter("ArchivoAlumnos.txt");
        ...
        private void btnCapturar_Click(object sender, EventArgs e)
        {
            ...
            if (contM <= objAlumno.numeroMaterias)
            {
                objAlumno.materias[contM] = txtMateria.Text;
                objAlumno.calificacion[contM] = double.Parse(txtCalificacion.Text);
                contM++;
                txtMateria.Text = "";
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            objAlumno.numeroMaterias = (int)nudCantidadMaterias.Value;
            objAlumno.materias = new string[objAlumno.numeroMaterias];
            objAlumno.calificacion = new double[objAlumno.numeroMaterias];
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (cont <= cantidadAlumnos)
            {
                ...
                objAlumno.MatA[cont] = (int)nudCantidadMaterias.Value;
        ...
        {
            Process.Start("ArchivoAlumnos.txt");
        }
        ...
        private void btnLeer_Click(object sender, EventArgs e)
        {
            ...
            leerArchivo = new StreamReader("ArchivoAlumnos.txt");

            MessageBox.Show(leerArchivo.ReadToEnd(), "ArchivoAlumnos.txt");
        }
    }
}
